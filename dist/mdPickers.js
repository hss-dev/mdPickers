...
function CalendarCtrl($scope, $element) {
    var self = this;
    if (!self.date){
        self.date = moment($scope.$parent.$root.date);
    }    
    ...
    this.$onInit = function(scope, element) {
        var animElements = [
        ...
        scope.$watch(function() {
            return self.date.format("YYYYMM")
